...
function changeContent(numTarea) {
  ...
  if (numTarea == 0) {
    if (ej == 1) {
      let texto1 = document.getElementById("p-tarea1").innerHTML = "";
      texto2 = document.getElementById("p-tarea2").innerHTML = "";
      texto3 = document.getElementById("p-tarea3").innerHTML = "";
      ...
      texto1.innerHTML = "En esta tarea se nos encomendó que mediante curvas parametrizadas puediésemos controlar la velocidad, permitiendo que esta sea constante o no (marcando cuanta distancia ha recorrido en qué frame)";
      texto2.innerHTML = "Para ello hemos requerido formar una tabla con cuanta distancia se ha recorrido en que frame. <img class='img-thumbnail' src='imagenes/curv1.png' width='400' height='200'> Por lo tanto con esta tabla podremos buscar que distancia queremos y nos dará en que frame aproximado se encuentra";
      texto3.innerHTML = "Para el cálculo de las velocidades. Utilizaremos un cambio de variable. De esta manera, si queremos obtener una velocidad constante calcularemos nuestra distancia como velocidad por tiempo y si queremos una velocidad que varíe en función de la distancia reparametrizaremos la curva. Que consistirá en obtener una nueva curva (s(t) = c(r(t))) de forma que se modifican los frames y la velocidad, pero las distancias serán iguales que las de la curva original. Para ello buscaremos a qué distancia se encuentra el objeto en el frame actual y luego obtendremos el frame que corresponde a esa distancia en nuestra tabla";
    ...
    if (ej == 1) {
      ...
      videoTareaSim.src = "./imagenes/pendulo.png";
      videoTareaSim.alt = "Tarea1 - Pendulo bidimensional"
      ...
      videoTareaSim.src = "./imagenes/wip.png";
      pTareaSim.innerHTML = "Estamos trabajando en esta práctica, cuando se complete, estará disponible.";
      if (wip)
        videoTareaSim.width = 400;
    } else if (ej == 4) {
      videoTareaSim1.style.display = "none";
